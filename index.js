...
function getTotalencounter() {

    $.ajax({
        url: './php/getTotalencounter.php',
        method: 'POST',
        data: {},
        dataType: 'json',
        success: (response) => {
            $.each(response, (key, value) => {
                document.querySelector('#totalEncounter').innerHTML = value.totalEncounter
            })
        }
    })
...
function getTotalEncounter() {
    ...
    $.ajax({
        url: './php/getTotaencounter.php',
        method: 'POST',
        data: {},
        dataType: 'json',
        success: (response) => {
            $.each(response, (key, value) => {
                document.querySelector('#totalEncounter').innerHTML = value.totaEncounter
            })
        }
    })
...
function getTotalMinor() {
    ...
    $.ajax({
        url: './php/getTotalMinor.php',
        method: 'POST',
        data: {},
        dataType: 'json',
        success: (response) => {
            $.each(response, (key, value) => {
                document.querySelector('#minor').innerHTML = value.minor
            })
        }
    })
